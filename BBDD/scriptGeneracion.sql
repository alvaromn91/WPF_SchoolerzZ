...
CREATE TABLE IF NOT EXISTS SZ_015_S_Licences(
    ...
    SZ_015_Students_Id BINARY(16),
    SZ_015_Using TINYINT DEFAULT(0),
    FOREIGN KEY(SZ_015_Students_Id)
        REFERENCES SZ_002_Students(SZ_002_Id)
);
CREATE TABLE IF NOT EXISTS SZ_016_T_Licences(
    SZ_016_Id BINARY(16) PRIMARY KEY,
    SZ_016_Licence VARCHAR(29)  NOT NULL,
    SZ_016_Teachers_Id BINARY(16),
    SZ_016_Using TINYINT DEFAULT(0),
    FOREIGN KEY(SZ_016_Teachers_Id)
        REFERENCES SZ_008_Teachers(SZ_008_Id)
);