...
CREATE TABLE IF NOT EXISTS SZ_015_S_Licences(
...
CREATE TABLE IF NOT EXISTS SZ_016_T_Licences(
    ...
    SZ_016_Usage TINYINT DEFAULT(0)
);
...
CREATE TABLE IF NOT EXISTS SZ_002_Students(
    ...
    FOREIGN KEY (SZ_002_Licence_Id)
		REFERENCES sz_015_s_licences(SZ_015_Id)
);
...
CREATE TABLE IF NOT EXISTS SZ_008_Teachers(
    ...
    SZ_008_Licence_Id Binary(16),
    SZ_008_Deleted TINYINT DEFAULT(0),
    FOREIGN KEY (SZ_008_Licence_Id)
		REFERENCES sz_016_t_licences(SZ_016_Id)
);
